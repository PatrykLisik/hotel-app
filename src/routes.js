module.exports = (app) => {
  ...
  app.get('/room', roomController.getOne)
  ...
  app.delete('/reservation', reservationController.delete)

  // Invoice api
  const invoiceController = require('./Controllers/InvoiceController')
  app.post('/invoice', invoiceController.create)
  app.get('/invoice/all', invoiceController.getAll)
  app.get('/invoice', invoiceController.getOne)
  app.delete('/invoice', invoiceController.delete)
}
